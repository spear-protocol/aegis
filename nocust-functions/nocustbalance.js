...
const checkNocustBalance = async () => {
  ...
  const balance = await nocust.getBalance(BOB_PUB, '0x292f648702122edA992ccB0e16926dB692E9509E');
  //const balance = await nocust.getBalance(BOB_PUB);
